...
function ProductsForm({ showProductForm, setShowProductForm, selectedProduct, getData }) {
    const [selectedTab= "1", setselectedrab] = React.useState("1")
    ...
    useEffect(() => {
        if (selectedProduct) {
            formRef.ref.current.setFieldsValue(selectedProduct);
        }
    }, [selectedProduct]);
    return (
        <Modal
        ...
        >
            <div>
                <h1 className="text-primary text-2xl text-center front-semibold uppercase">
